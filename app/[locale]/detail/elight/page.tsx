      ...
      <section className="relative w-full h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 lg:px-8 h-full flex items-center justify-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">{t.elight.title}</h1>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-dark mb-6">
              {t.elight.comingSoonTitle}
            </h2>
            <p className="text-xl text-gray-medium mb-8">
              {t.elight.comingSoonDesc}
            </p>
            <p className="text-lg text-gray-medium mb-12">
              {locale === 'fr' 
                ? 'Inscrivez-vous pour être notifié lorsque l\'ELIGHT sera disponible. Soyez parmi les premiers à découvrir l\'avenir de la mobilité électrique.'
                : 'Sign up to be notified when the ELIGHT becomes available. Be among the first to experience the future of electric mobility.'}
            </p>
            <div className="bg-white rounded-lg p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-dark mb-4">
                {t.elight.stayUpdated}
              </h3>
              <p className="text-gray-medium mb-6">
                {locale === 'fr'
                  ? 'Soyez notifié dès que l\'ELIGHT sera disponible pour la précommande.'
                  : 'Get notified as soon as the ELIGHT is available for pre-order.'}
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-dark mb-2">
                  {t.elight.advancedTechnology}
                </h3>
                <p className="text-gray-medium">
                  {t.elight.advancedTechnologyDesc}
                </p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-dark mb-2">
                  {t.elight.ecoFriendly}
                </h3>
                <p className="text-gray-medium">
                  {t.elight.ecoFriendlyDesc}
                </p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-dark mb-2">
                  {t.elight.premiumQuality}
                </h3>
                <p className="text-gray-medium">
                  {t.elight.premiumQualityDesc}
                </p>
              </div>
            </div>
          </motion.div>
