...
export default function EV2Detail() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 lg:px-8 h-full flex items-center justify-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">EV2</h1>
            <p className="text-xl md:text-2xl opacity-90 mb-8">
              Spacious and Versatile Electric Vehicle
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <div className="mt-12 p-8 bg-primary/10 rounded-lg">
              ...
              <p className="text-gray-medium">
                The cruising range of JMEV EV2 is 201km. Equipped with the 30% efficient energy recovery system, low battery reminder and range protection functions.
              </p>
            </div>
          </motion.div>
        </div>
